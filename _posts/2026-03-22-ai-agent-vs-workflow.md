...
![Agent 执行流程](/assets/img/posts/ai-agent-vs-workflow-agent-flow.png)
...
![客服 Workflow 示例](/assets/img/posts/ai-agent-vs-workflow-customer-service.png)
...
![Agent 调用 Workflow](/assets/img/posts/ai-agent-vs-workflow-agent-workflow.png)
