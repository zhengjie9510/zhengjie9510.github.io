...
license: false
---
海岸线提取是找工作时遇到的一道测试题，因为时间有限，所以代码简单粗暴。具体要求是设计一种算法来从给定影像中检测海岸线，并将结果另存为矢量GeoJSON文件。
<!--more-->
## 思路
...
```
二值化结果展示：  
![二值化结果](\assets\images\Python之海岸线提取\水体和陆地.png)
### 边缘检测
```python
# find contours
...
```
## 结果展示  
![海岸线](\assets\images\Python之海岸线提取\海岸线.jpg)  
如果对您有用的话，别忘了给点个赞哦^_^ ！