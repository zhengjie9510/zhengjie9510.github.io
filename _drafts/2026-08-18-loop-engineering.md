...
但它远不是驱动智能体的唯一循环。《Loopcraft: The Art of Stacking Loops》这篇文章提出了一个关键洞见：你可以不断**叠加和延伸循环**，从而构建出更强大的智能体。具体来说，从内到外一共四层——**智能体循环**负责执行、**验证循环**把控质量、**事件驱动循环**唤醒服务、**自优化循环**推动进化。
...
![智能体循环](/assets/img/posts/loop-engineering-agent-loop.png)
...
![验证循环](/assets/img/posts/loop-engineering-verification-loop.png)
...
![事件驱动循环流程](/assets/img/posts/loop-engineering-event-driven-flow.png)
...
![自优化循环流程](/assets/img/posts/loop-engineering-self-optimization-flow.png)
